...
'''
all_include_dirs=find_include_dirs()
ext_modules = ([
    Extension(
...
## conda install nvidia/label/cuda-12.4.1::cuda-nvrtc
#conda list |grep gcc
# conda env config vars set CUDA_PATH="/gpfs/home/user19/WorkSpace/00sortware/anaconda3/envs/ccx/targets/x86_64-linux"
# /include/crt
#################