...
ClusteringResult cellcloudx::computeKCenterClustering(const Matrix& data,
...
Float cellcloudx::updateClustering(const Matrix& data,
...
Vector cellcloudx::calcRadii(const Matrix& data,
                          const Matrix& cluster_centers,
