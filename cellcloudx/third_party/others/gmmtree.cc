...
NodeParamArray cellcloudx::buildGmmTree(const MatrixX3& points,
...
NodeParamArray cellcloudx::gmmTreeEstep(const MatrixX3& points,
...
NodeParamArray cellcloudx::gmmTreeRegEstep(const MatrixX3& points,
                                        const NodeParamArray& nodes,
                                        Integer max_tree_level,
                                        Float lambda_c) {
    const Integer n_total = N_NODE * (1 - std::pow(N_NODE, max_tree_level)) / (1 - N_NODE);
