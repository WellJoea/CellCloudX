...
from ..transform import homotransform_point, homotransform_points
...
class stackregist():
    ...
    def buildidx(self, n_node,
                        ...
                        show_tree=False, 
                        layout="spectral"):
        align_pair, trans_pairs = searchidx(n_node,
                                                labels=None,
                                                step=step, 
                                                root=root, 
    ...
    def opencv(self, fix, mov):
        rg = feature_regist(transtype= self.cv2args['transtype'])
    ...
    def opencv_pipe(fix, mov, **kargs):
        rg = feature_regist(transtype= kargs['transtype'])
