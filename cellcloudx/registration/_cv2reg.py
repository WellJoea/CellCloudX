...
class cv2regist():
    ...
    def transform(self, 
        ...
        mov_out = homotransform(moving_img, tmat, inverse=inverse, order=order, **kargs)
    ...
    def regist_transform(self, fixed_img, moving_img, 
        ...
        self.transform(moving_img, locs=locs, order=order, inverse=inverse, swap_xy=swap_xy, **targs)
        # return self
