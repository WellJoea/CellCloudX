...
class sitkregist:
    ...
    def __init__(self, transtype='rigid', dimension=2):
    ...
    def regist(self, 
        ...
        fixed_sitk = self.image2sitk(fixed_img, self.dimension)
        moving_sitk = self.image2sitk(moving_img, self.dimension)
        ...
        self._Matrix( matrix_type=matrix_type, **matrix_kargs)
    ...
    def _transformer(self, fixed_image=None, 
        ...
        try:
            tranformer = transdict[self.dimension][self.transtype]
        except KeyError:
    ...
    def _optimizer(self, optimizer_type='GD', **kargs):
        ...
        if optimizer_type == 'GD':
            ...
            self.reg_method.SetOptimizerAsRegularStepGradientDescent(
                ...
                gradientMagnitudeTolerance=kargs.pop('gradientMagnitudeTolerance', 1e-5),
            ...
            self.reg_method.SetOptimizerAsExhaustive(
                    kargs.pop('numberOfSteps',  [5]*self.dimension*2),
            ...
            self.reg_method.SetOptimizerWeights( kargs.pop('weights',[1]*self.dimension*2) )
