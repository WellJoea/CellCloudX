...
from ..utilis import list_get
from ..io import read_image_info, write_image_info, write_image_infos
from ..transform import (padding, rescale_points, homotransform_points, homotransforms, rescales)
#from .. import log
...
class spatialalign3d():
    ...
    def update(self, transformRecords = None, padingsize = 'auto',
                ...
                keeptype=True,
                img_key = 'hires',
                interp_method = 'skimage', backend='loky',
