import numpy as np
def trim_points_from_mesh(mesh, points, hash_resolution=512, use_numba=True):
    if use_numba:
        from ._inside_mesh_numba import trim_points_from_mesh_numba
        return trim_points_from_mesh_numba(mesh, points, hash_resolution)
    else:
