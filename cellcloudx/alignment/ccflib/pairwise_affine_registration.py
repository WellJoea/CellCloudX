...
class pwAffineRegistration(pwEMRegistration):
    def __init__(self, *args, 
                 A=None, t = None,
                 gamma1=None, delta=0, transparas={},
        ...
        self.init_transparas(delta=delta, gamma1=gamma1, kw=kw, kd_method=kd_method, transparas=transparas)
        self.init_transformer( A=A, t=t)
        self.init_L()

    def init_transparas(self, transparas={}, delta=0, gamma1 = 0, kw=15, kd_method='sknn'):
        self.transparas = self.default_transparas()[self.transformer]
        self.transparas['delta'] = delta or 0.0
