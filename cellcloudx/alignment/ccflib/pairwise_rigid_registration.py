...
class pwRigidRegistration(pwEMRegistration):
    def __init__(self, *args, 
                   ...
                   fix_s=True, s_clip=None, transparas={},
                   **kwargs):
        super().__init__(*args, **kwargs)
        self.transformer = 'E'
        self.tol =  1e-9 if self.tol is None else self.tol
        self.normal = False if self.normal is None else self.normal #or global
        ...
        self.init_transparas(fix_s=fix_s, s_clip=s_clip, transparas=transparas)
