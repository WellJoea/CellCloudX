...
# from .deprecated.reference_affine_recorrection import rfAffineRecorrection
# from .deprecated.reference_deformable_recorrection import rfDeformableRecorrection
...
from . import (
    ...
    neighbors_ensemble, shared_wnn, xmm, pairwise_llt_registration, reference_emregistration
)