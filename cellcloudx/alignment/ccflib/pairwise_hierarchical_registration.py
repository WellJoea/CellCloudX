...
class pwHierarchicalRegistration:
    def __new__(cls, *args, **kwargs):
        df_version = kwargs.get('df_version', 1)
        if df_version == 0:
            bases = (HierarchicalRegistration_0,)
        elif df_version == 1:
            bases = (HierarchicalRegistration_1,)
        elif df_version == 2:
            bases = (HierarchicalRegistration_2,)
        elif df_version == 3:
            bases = (HierarchicalRegistration_3,)
        else:
            raise ValueError("Invalid df_version")

        new_cls = type('HierarchicalRegistration', (cls,) + bases, {})
        instance = object.__new__(new_cls)
        return instance

    def __init__(self, *args, transparas={}, **kwargs):
        self.df_version = kwargs.pop('df_version', 1)
        super().__init__(*args, **kwargs)
        self.each_ncols = 3
        self.reg_core = 'hierarchical'
        self.transformer = 'H'
        ...
        self.init_transparas(transparas=transparas, **self.transparas)
    ...
    def init_transparas(self, transparas={}, **kwargs):
        ipara = self.default_transparas()[self.transformer]
        ipara.update(kwargs)
        ipara.update(transparas)
        ...
        #TODO :check gamma1, gamma2
        ipara['beta']  *= (self.scale_factor**2)
        ipara['alpha'] /= (self.scale_factor**2)
        ##########################
...
class HierarchicalRegistration_0(pwEMRegistration):
    def __init__(self, *args, 
        ...
        self.pwexpectation_d = self.pwexpectation_df
...
class HierarchicalRegistration_1(pwEMRegistration):
...
class HierarchicalRegistration_2(HierarchicalRegistration_1):
...
class HierarchicalRegistration_3(HierarchicalRegistration_1):
